...
export function ItemPage() {
  ...
  const resource = useApiResource(
    () => itemId ? Promise.all([api.item(itemId), api.attachments(itemId), api.userPreferences()]) : Promise.reject(new Error("文献地址无效")),
    [itemId],
  );
  ...
  const [item, attachments, preferences] = resource.data;
