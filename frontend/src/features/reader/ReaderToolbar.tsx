...
interface Props {
  ...
  actions?: ReactNode;
  readerMode: "pdf" | "semantic";
  onSelect: (attachment: Attachment) => void;
  onColorMode: (mode: PdfColorMode) => void;
  onFullscreen: () => void;
  onReaderMode: (mode: "pdf" | "semantic") => void;
}
